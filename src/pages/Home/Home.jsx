   ...
   return (
      <>
         <section className="w-full h-screen flex justify-center items-center bg-gradient-to-r from-green-500 to-emerald-500">
            <div className="h-115 flex-col flex items-center justify-center shadow-xl bg-corCard border-4 border-solid border-white-100 s380:w-82 s430:w-96 s530:w-106 s830:w-116 s1030:w-1/2">
               <h1 className="text-green-300 font-semibold text-center s380:text-xl s430:text-xl s630:text-3xl s930:text-2 s1030:text-4xl">
               ...
               {iniciar == false ? (
                  <div className="flex gap-12 mt-7 s380:gap-3 s430:gap-5 s1030:gap-10">
                     {dataDificuldade.map((nivelDificuldade) => (
                        ...
                        <button
                           className="bg-green-500 border-2 border-green-700 h-8 hover:bg-green-600 text-white text-lg s380:w-16 s430:w-20 s430:text-base s530:w-28 s530:text-lg s1030:w-32"
                           onClick={() =>
               ...
               <button
                  className="bg-green-500 border-2 border-green-700 h-8 m-5 hover:bg-green-600 text-white text-center s380:w-16 s380:m-3 s380:text-xs s430:w-20 s430:text-base s530:w-28 s530:text-lg s1030:w-32 s1030:m-6"
                  onClick={() => {
               ...
               <AnimatePresence>
                  {iniciar && (
                     <>
                        ...
                        <div className="bg-green-500 w-2/3 h-14 s380:mt-3 flex s430:mt-1 justify-center border-2 border-green-700 items-center ">
                           <h1 className="text-white text-center font-semibold s380:text-xs s430:text-base ">
                              {descQntd}
                           </h1>
                        </div>
                        {/*
